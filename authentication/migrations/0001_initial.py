    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fin_kod', models.CharField(blank=True, max_length=10, verbose_name='FIN kod')),
                ('id_card_serial', models.CharField(blank=True, max_length=20, verbose_name='Şəxsiyyət vəsiqəsinin seriya nömrəsi')),
